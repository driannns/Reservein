<x-app-layout>
    <div class="w-10/12 mx-auto">
        <div class="flex items-center justify-between mx-auto" style="font-family: 'Poppins', sans-serif;">
            ...
            <div class="w-4/6">
                <form class="grid gap-3" action="" method="POST">
                    ...
                    <div class="flex w-full gap-3">
                        ...
                        <div class="w-full">
                            <input class="w-full bg-transparent p-4 text-sm border-[#dddddd]" type="tel"
                    ...
                    <textarea class="w-full bg-transparent p-4 text-sm border-[#dddddd]" name="request" id="request"
                        rows="6" placeholder="Special Requests"></textarea>
                    ...
                    <div class="flex gap-4">
                        <button class="bg-white text-[#b0b0b0] py-4 px-4 rounded-lg">Previous</button>
                        <button class="bg-[#3554D1] text-white py-4 px-4 rounded-lg">
                            <div class="flex items-center gap-2">
                                Next
            ...
            <div class="w-2/6 h-fit p-4">
                ...
                <div class="flex w-full">
                    ...
                    <div class="w-4/6 h-full ml-3 flex flex-col justify-between">
                        <div class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#F8D448" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#F8D448" class="w-3 h-3">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex items-center mt-3">
                            <div class="grid place-content-center w-7 h-7 text-xs font-semibold rounded-md bg-[#3554D1] text-white">
                                4.8
                            </div>
