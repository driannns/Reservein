        ...
        <form method="post" action="{{ route('profile.update') }}" class="w-9/12 mt-6 space-y-6"
            ...
            <div class="mt-3">
                ...
                <select
                    ...
                    <option value="" disabled>Choose you gender</option>
                    <option value="Men" {{ old('gender', $user->email) == 'Men' ? 'selected' : '' }}>Men</option>
                    <option value="Women" {{ old('gender', $user->email) == 'Women' ? 'selected' : '' }}>Women</option>
                </select>
