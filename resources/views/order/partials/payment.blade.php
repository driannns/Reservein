        ...
        <div class="w-4/6">
            ...
            <div>
                ...
                <select id="id_select2_example" name="paymentmethod"
                    ...
                    <option data-img_src='/assets/payment/permatabank.png' value="Permata Bank">Permata Bank</option>
                </select>
            </div>
            <div>
            ...
            <div class="flex gap-4 mt-3">
                <a href="{{route('order', $room->id)}}" class="bg-white text-[#b0b0b0] py-4 px-4 rounded-lg">Previous</a>
            ...
            <div class="w-2/6 h-fit ml-16 p-5 border border-[#dddddd]">
                ...
                <div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <p>@currency($total)</p>
                        @else
                        <input type="hidden" value="{{ $hargaRuangan }}" name="totalprice">
                        <p>@currency($hargaRuangan)</p>
                        @endif
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    const checkbox = document.getElementById('pointCheck');
    let points = 0;
